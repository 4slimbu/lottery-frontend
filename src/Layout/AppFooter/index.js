      ...
      <Fragment>
        <footer>
          <div className="container">
            <div className="row">
              <div className="col-sm-12 col-md-12 col-lg-12 footer-left">
                ...
                <p>
                  ...
                  <strong>{findSetting(settings, "app_name").value}.</strong>{" "}
                  All rights reserved.
                </p>
              </div>
              {/*<div className="col-sm-12 col-md-6 col-lg-6 footer-right">
                <ul className="social-icons">
                  <li>
                    <a href={findSetting(settings, "app_facebook_url").value}>
                      <FontAwesomeIcon icon={faFacebook} />
                    </a>
                  </li>
                  <li>
                    <a href={findSetting(settings, "app_twitter_url").value}>
